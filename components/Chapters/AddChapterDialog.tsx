// components/admin/chapters/AddChapterDialog.tsx
"use client";
...
export function AddChapterDialog({
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const { data, error } = await supabase
      ...
      .insert({ title, description, order_index, course_id: courseId })
      .select("*, course_videos!left(*)")
      .single();
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="order_index" className="text-right">رقم الترتيب</Label>
