...
import { EditChapterDialog } from "@/components/Chapters/EditChapterDialog"; // تأكد من استيراد هذا أيضًا
    ...
    <div className="p-4 sm:p-6 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {chapters.length > 0 ? (
          <ChapterList
            chapters={chapters}
            // -- الخصائص المفقودة التي تم إضافتها --
            courseId={COURSE_ID}
            onVideosAssigned={handleVideosAssigned}
            // ------------------------------------
